 ...
 * {ERC721Enumerable}.
 */
contract ERC721Payable is Context, ERC165, IERC721Payable, IERC721MetadataPayable {
    ...
    function _transfer(
        ...
        require(ERC721Payable.ownerOf(tokenId) == from, "ERC721: transfer from incorrect owner");
